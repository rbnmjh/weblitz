...
// ================================================
	...
	function TinyMCE_ibrowser_getControlHTML(control_name) {
		switch (control_name) {
			case 'ibrowser':
				return '<img id="{$editor_id}_ibrowser" src="http://localhost/text_editor/assets/tinymce/jscripts/tiny_mce/plugins/ibrowser/images/ibrowser.gif" title="iBrowser" width="20" height="20" class="mceButtonNormal" onmouseover="tinyMCE.switchClass(this,\'mceButtonOver\');" onmouseout="tinyMCE.restoreClass(this);" onmousedown="tinyMCE.restoreAndSwitchClass(this,\'mceButtonDown\');" onclick="(iBrowser_click(\'{$editor_id}\'));">';
			}	
		return '';
	}
	//-------------------------------------------------------------------------
	...
	function iBrowser_click(editor) {
		...
		ib.baseURL = 'http://localhost/text_editor/assets/tinymce/jscripts/tiny_mce/plugins/ibrowser/ibrowser.php';
	...
	js.src  = 'http://localhost/text_editor/assets/tinymce/jscripts/tiny_mce/plugins/ibrowser/interface/common.js';
