...
<div class="main_content"> 
   ...
   <div class="center_content">
      <div class="right_content">
         <h2>Portfolio > Edit portfolio:</h2>
                     ...
                     <tr>
                        <td valign="top">
                           <table class="adminform">
                              <tbody>
                                 <tr>
                                    <th colspan="2">Edit Portfolio Content:</th>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Project Name<span class="required">*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->textField($portfolio, 'name', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Image<span class="required">*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->filefield($portfolio, 'image', array('class' => 'required text_area', 'size' => '10'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textField($portfolio, 'url', array('class' => 'text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textArea($portfolio, 'content', array('class' => 'required text_area', 'width' => '1000', 'height' => '1000' ,'maxlength' => '700','rows'=>'250','cols'=>'100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->radioButtonList($portfolio, 'status', array( '0' => 'unpublished', '1' => 'published'),array('separator'=>'  '));
                                       ?>
                                    </td>
                                 </tr>
