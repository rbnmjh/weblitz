                     ...
                     <tr>
                        <td valign="top">
                           <table class="adminform">
                              <tbody>
                                 <tr>
                                    <th colspan="2">Edit Our Team Content:</th>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Name<span class="required">*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->textField($ourteam, 'name', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textArea($ourteam, 'content', array('class' => 'required text_area', 'width' => '1000', 'height' => '1000' ,'maxlength' => '700','rows'=>'250','cols'=>'100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->filefield($ourteam, 'image', array('class' => 'required text_area', 'size' => '10'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->radioButtonList($ourteam, 'status', array( '0' => 'unpublished', '1' => 'published'),array('separator'=>'  '));
                                       ?>
                                    </td>
                                 </tr>                               
                                 <tr>
