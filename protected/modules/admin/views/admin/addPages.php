                           ...
                           <table class="adminform">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textField($page, 'name', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->filefield($page, 'image', array('class' => 'text_area', 'size' => '10'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->radioButtonList($page, 'status', array( '0' => 'unpublished', '1' => 'published'),array('separator'=>'  '));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
