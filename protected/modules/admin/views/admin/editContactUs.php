...
<div class="main_content"> 
   ...
   <div class="center_content">
      <div class="right_content">
         <h2>Contact Us > Edit contact us:</h2>
                     ...
                     <tr>
                        <td valign="top">
                           <table class="adminform">
                              <tbody>
                                 <tr>
                                    <th colspan="2">Edit Contact us Content:</th>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Email<span class="required">*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->textField($contactus, 'email', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textArea($contactus, 'message', array('class' => 'required text_area', 'width' => '1000', 'height' => '1000' ,'maxlength' => '700','rows'=>'250','cols'=>'100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
